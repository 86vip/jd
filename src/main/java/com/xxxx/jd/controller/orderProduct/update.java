...
@WebServlet("/orderProduct/update")
public class update extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        orderProduct.setId(Integer.valueOf(req.getParameter("opId")));
        ...
        Object r = orderProductService.updateOrderProduct(orderProduct);
        ResultInfo resultInfo;
        if (r instanceof String) {
            resultInfo = Result.fail((String) r);
        } else {
            resultInfo = Result.success("修改产品成功！");
        }
