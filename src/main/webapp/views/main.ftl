        ...
        <div class="layui-side-scroll layui-left-menu">
            <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"  data-tab="user/index"><i class="fa fa-street-view"></i><span class="layui-left-nav"> 用户管理</span> </a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"  data-tab="role/index"><i class="fa fa-street-view"></i><span class="layui-left-nav"> 角色管理</span> </a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"  data-tab="sale_chance/index"><i class="fa fa-street-view"></i><span class="layui-left-nav"> 营销管理</span> </a>
                </li>
                <li class="layui-nav-item">
